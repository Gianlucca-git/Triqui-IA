...
window= pygame.display.set_mode ((495,695))
                         ...
                         if pos[0] > posiciones_imagenes[i][0] and pos[1] > posiciones_imagenes[i][1]:
                             ...
                             if pos[0] < area_imagenes[i][0] and pos[1] < area_imagenes[i][1] :
                                 ...
                                 if ocupado[i] == 0 : ##condicion que valida si se puede dar en ese lugar
                                     ...
                                     if turno : ## condicion que cambia el turno     ## Empieza el tuno del Jugador
                                 ...
                                 ##    else:   ## Empieza el turno de la Maquina

                                         
                                 
                                            turno = True
                                            movimiento_maquina =  IA()

                                            if ocupado.count(0) > 1 :## condicion para que el jugar pueda dar el ultimo tiro en caso de no quedar mas casillas
